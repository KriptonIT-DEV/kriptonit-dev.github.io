...
<Code lang="http" code={`POST ${BASE_API_URL}/api/oauth/token`} />
...
<Code
  lang="bash"
  code={`curl -X POST ${BASE_API_URL}/api/oauth/token \\
...
<Code
  lang="javascript"
  code={`const response = await fetch('${BASE_API_URL}/api/oauth/token', {
    method: 'POST',
...
<Code
  ...
  url = "${BASE_API_URL}/api/oauth/token"
  payload = {
      "client_id": "tu_client_id",
      "client_secret": "tu_client_secret",
      "grant_type": "client_credentials"
...
<Code
  ...
  var request = HttpRequest.newBuilder()
      .uri(URI.create("${BASE_API_URL}/api/oauth/token"))
...
<Code lang="http" code={`GET ${BASE_API_URL}/api/oauth/token-verify`} />
...
<Code
  lang="bash"
  code={`curl -X GET ${BASE_API_URL}/api/oauth/token-verify \\
...
<Code
  lang="javascript"
  code={`const response = await fetch('${BASE_API_URL}/api/oauth/token-verify', {
...
<Code
  ...
  url = "${BASE_API_URL}/api/oauth/token-verify"
...
<Code
  ...
  var client = HttpClient.newHttpClient();
  var request = HttpRequest.newBuilder()
      .uri(URI.create("${BASE_API_URL}/api/oauth/token-verify"))
