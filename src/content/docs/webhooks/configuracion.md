...
2. Selecciona el canal que querés conectar (WhatsApp, Messenger, etc.) y genera tus credenciales (`client_id` / `client_secret`). Las vas a necesitar para [autenticarte](/authentication/) y para validar la firma de los webhooks.
