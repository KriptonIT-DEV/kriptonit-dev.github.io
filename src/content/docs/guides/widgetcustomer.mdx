...
Este es un complemento de nuestro widget que requiere una clave pública de autenticación.
...
<Code
  ...
  code={`<script type="module">
    import  { konnectchatdata } from "${BASE_API_WIDGET}/widget/konnectchat.es.min.js";
    // ...

    konnectchatdata("your_widget_chat_name", {
      publicKey: 'xxxx-yyyy-xxxx-yyyy-xxxx-yyyy', // esta clave pública se genera en la plataforma principal
      apiQuery: {
